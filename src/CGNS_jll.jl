...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CGNS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5232ba32-63ef-5a57-8e6a-e52ba13cfec0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CGNS", artifacts_toml) for e in artifacts["CGNS"]]
...
if best_platform === nothing
    @debug("Unable to load CGNS; unsupported platform $(triplet(platform_key_abi()))")
else
